...
MAX_EVALS=2000000
MAX_WALL=7200
POLICY="Fable D-ladder 2026-09-24: soft guard cap 10 for all ladder runs (hard 1.0 only for the rung-1 tinyns documentation pair); budgets: first of dlogz 0.1, 2,000,000 evaluations, 2 h sampling wall (core-main and O1 dynesty rung 1: 20,000 evaluations)"
...
nm() { local arm=$1 rung=$2 sampler=$3 guard=$4; if [ $guard = hard ]; then echo G5_${arm}_r${rung}_${sampler}_hard1; else echo G5_${arm}_r${rung}_${sampler}_soft10; fi; }
